...
//qa
fis.media('qa')
.set('statics', '/adman/statics')//static目录
.match("mock/**", {
  release: "/adman/$&"
})
.match(/^\/page\/(.*)$/i, {
...
.match('*', {
  deploy: fis.plugin('http-push', {
    // receiver: 'http://192.168.0.201:8080/upload.php',
    receiver: 'http://upload.hanguo.com:8080/upload.php',
    // receiver: 'http://upload.hanguo.com:8080/upload.php',
    to: '/home/work/hanguo/www/yiying/' // 注意这个是指的是测试机器的路径，而非本地机器
  })
});
